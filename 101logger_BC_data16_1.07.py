...
class signaloscs:
    ...
    def PRF(self,name):
        try:
            #'Time', 'RF_UG1', "RF_UA1", "Cath1_C", 'S_C1(A)', 'PRF'
            #'Time',,,,,'PRF'
            alfa=np.arccos((-480+403)/self.ColumnNamesDict['RF_UG1'].readsinglevalue())
            URF=self.ColumnNamesDict["RF_UA1"].readsinglevalue()
            C_C=self.ColumnNamesDict["Cath1_C"].readsinglevalue()
            S_C1=self.ColumnNamesDict['S_C1(A)'].readsinglevalue()
            ...
            if True:#self.ColumnNamesDict[name] == '':
                try:
                    ...
                    try:
                        ...
                        self.ColumnNamesDict[name].setT2(float(sys.argv[1]))
...
class LOG:
    ...
    def buildtable(self,names=''):
        ...
        try:#2022-04-04
            ...
            self.T=[keys for keys in self.Log]#2022-04-04
